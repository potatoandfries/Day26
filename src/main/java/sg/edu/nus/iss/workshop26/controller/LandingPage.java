...
public class LandingPage {
    ...
    public ResponseEntity<String> getAllGame(@RequestParam Integer limit, @RequestParam Integer offset){
        List<Game> results = svc.searchGame(limit, offset);
        
        JsonObject result =null;
        JsonObjectBuilder objBuilder = Json.createObjectBuilder();
        //this is where the new model comes in handy*
        //now you need to repackage it back to json.
        Games gs = new Games();
        gs.setGames(results);
    ...
    public ResponseEntity<String> getGamesByRanking(){
        ...
        List<Game> results = svc.getGamesByRank();
    ...
    {
        JsonObject result = null;
        Game gameDetails = svc.getGameDetails(gameId);
        JsonObjectBuilder objBuilder = Json.createObjectBuilder();
    ...
    public ResponseEntity<String> searchComment(
        ...
        List<Comment> results = svc.searchComment(q, score, 20, 0);
        JsonArray result = null;
        JsonArrayBuilder arrBuilder = Json.createArrayBuilder();
